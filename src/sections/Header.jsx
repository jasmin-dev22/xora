...
import { Button, Link, Link as LinkScroll } from "react-scroll";
...
const Header = () => {
  ...
  const NavLink = ({ title }) => (
    <LinkScroll to={title} offset={-100} smooth spy  activeClass="nav-active" className="base-bold text-p4 uppercase transition-colors duration-500 cursor-pointer hover:text-p1 max-lg:my-4 max-lg:h5"
            ...
            <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
              <ul className="flex max-lg:block max-lg:px-12">
                ...
                <li className="nav-logo">
                  <LinkScroll to="hero" offset={-150} spy smooth className={clsx('max-lg:hidden transition-transform duration-500 cursor-pointer')}>
                    <img
                      src="/images/xora.svg"
                      width={160}
                      height={55}
